...
# 출력 디렉토리 생성
output_dir = "/home/maiordba/projects/vision/Wan2.2/lora_inference_results"
os.makedirs(output_dir, exist_ok=True)

print("=" * 80)
print("480x832x9 LoRA Model Inference Test")
print("=" * 80)
...
try:
    ...
    # 대체 방법: safetensors로 직접 로드
    from safetensors.torch import load_file
    lora_weights = load_file(lora_path)
    print(f"LoRA weights keys: {list(lora_weights.keys())[:5]}...")  # 처음 5개 키만 출력
...
for i, test in enumerate(test_prompts, 1):
    ...
    try:
        ...
        # 비디오 저장
        output_path = os.path.join(output_dir, f"{test['name']}_lora.mp4")
