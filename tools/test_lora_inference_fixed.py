#!/usr/bin/env python3
"""
LoRA 모델 추론 테스트 스크립트 (수정 버전)
480x832x9 해상도로 학습된 LoRA 모델 평가 - 올바른 LoRA 로드 방법 사용
"""
...
# 출력 디렉토리 생성
output_dir = "/home/maiordba/projects/vision/Wan2.2/lora_inference_results_with_lora"
os.makedirs(output_dir, exist_ok=True)

print("=" * 80)
print("480x832x9 LoRA Model Inference Test (FIXED)")
print("=" * 80)

# LoRA 모델 경로
lora_path = "/home/maiordba/projects/vision/Wan2.2/diffsynth_lora_output_480x832x9_1k/epoch-0.safetensors"
...
# ⭐ 올바른 LoRA 로드 방법
print(f"\nLoading LoRA weights using correct method...")
try:
...
for i, test in enumerate(test_prompts, 1):
    ...
    try:
        ...
        # 비디오 저장
        output_path = os.path.join(output_dir, f"{test['name']}_with_lora.mp4")
