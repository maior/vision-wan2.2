#!/bin/bash
# DiffSynth-Studio LoRA Training - Resume from epoch-0 to epoch-2
...
cat > /home/maiordba/projects/vision/Wan2.2/training_config.json << 'EOF'
{
  ...
  "batch_size": 1,
  "description": "Resume: 480x832x9, 1K samples, epoch 0→2, Single GPU"
}
EOF
...
echo "============================================================"
echo "LoRA Training Resume: epoch-0 → epoch-2"
echo "============================================================"
echo "Current checkpoint: epoch-0.safetensors"
echo "Target: epoch-2.safetensors"
echo "Estimated time: 3-4 hours"
echo "============================================================"

# Training parameters - Resume training
# Note: 같은 output_path를 사용하면 자동으로 마지막 epoch부터 재개됩니다
accelerate launch --config_file /home/maiordba/projects/vision/Wan2.2/accelerate_config_single.yaml \
  ...
  --output_path "/home/maiordba/projects/vision/Wan2.2/diffsynth_lora_output_480x832x9_1k" \
  --lora_base_model "dit" \
...
echo "Checkpoints saved in: diffsynth_lora_output_480x832x9_1k/"
echo "============================================================"
