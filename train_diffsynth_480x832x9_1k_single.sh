#!/bin/bash
# DiffSynth-Studio LoRA Training - 480x832x9, 1K samples, Single GPU
# Memory-optimized test for 32GB V100
...
cat > /home/maiordba/projects/vision/Wan2.2/training_config.json << 'EOF'
{
  ...
  "batch_size": 1,
  "description": "Test: 480x832x9, 1K samples, Single GPU"
}
EOF
