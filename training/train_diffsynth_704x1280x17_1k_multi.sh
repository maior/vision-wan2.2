#!/bin/bash
# DiffSynth-Studio LoRA Training - 704x1280x17, 1K samples, MULTI GPU (2x V100)
# Full RAPA resolution with distributed training
...
cat > /home/maiordba/projects/vision/Wan2.2/training/training_config.json << 'EOF'
{
  ...
  "steps_per_epoch": 500,
  "batch_size": 1,
  "description": "RAPA Full Resolution: 704x1280x17, 1K samples, Multi GPU"
}
EOF
...
# Training parameters - FULL RESOLUTION 704x1280x17
accelerate launch --config_file /home/maiordba/projects/vision/Wan2.2/accelerate_config.yaml \
  ...
  --output_path "/home/maiordba/projects/vision/Wan2.2/diffsynth_lora_output_704x1280x17_1k" \
  --lora_base_model "dit" \
